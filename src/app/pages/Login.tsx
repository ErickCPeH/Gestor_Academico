      ...
      <div className="flex-1 flex items-center justify-center bg-[#F5F5F5] px-6 py-12">
        <div className="w-full max-w-md">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border border-[#E0E0E0]">
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="username" className="text-[#2C2C2C]">
                    Usuario
                  </Label>
                  <Input
                    id="username"
                    ...
                    className="bg-[#F9F9F9] border-[#D0D0D0] focus-visible:ring-[#DC143C]"
                    required
                  />
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    className="border-[#D0D0D0] data-[state=checked]:bg-[#DC143C] data-[state=checked]:border-[#DC143C]"
                  />
                  <Label
                    htmlFor="remember"
                    className="text-sm text-[#5A5A5A] cursor-pointer"
                  >
                    Recordarme
                  </Label>
                </div>
              ...
              <Button
                type="submit"
                className="w-full mt-6 bg-[#DC143C] hover:bg-[#B01030] text-white h-11"
              >
                Iniciar Sesión
              </Button>
              ...
              <div className="mt-4 text-center">
                <a
                  href="#"
                  className="text-sm text-[#DC143C] hover:text-[#B01030]"
                >
          ...
          <p className="mt-8 text-center text-sm text-[#5A5A5A]">
            © 2026 Universidad del Valle de México
          </p>
        </div>
      </div>
    </div>
